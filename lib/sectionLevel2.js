...
const alllergiesTextHeaders = ["Substance", "Overall Severity", "Reaction", "Reaction Severity", "Status"];
...
const medicationsTextHeaders = ["Medication Class", "# fills", "Last fill date"];
