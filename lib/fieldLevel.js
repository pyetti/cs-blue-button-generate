...
const bbm = require("./blue-button-meta/CCDA/");
...
const templateCodes = bbm.sections_entries_codes.codes;
...
const effectiveTimeNow = exports.effectiveTimeNow = {
    key: "effectiveTime",
    attributes: {
...
const effectiveTime = exports.effectiveTime = {
    key: "effectiveTime",
    attributes: {
...
const usRealmAddress = exports.usRealmAddress = {
    key: "addr",
    attributes: {
...
const usRealmName = exports.usRealmName = {
    key: "name",
    content: [{
        key: "family",
...
const assignedEntity = exports.assignedEntity = {
    key: "assignedEntity",
    content: [id, {
            key: "code",
